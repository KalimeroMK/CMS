        ...
        <div class="main-content mag-content clearfix">
            ...
            <div class="row blog-content">
                ...
                <div class="col-md-4">
                    <aside class="sidebar clearfix">
                        ...
                        @if(isset($ads[\App\Ad::TYPE_SIDEBAR][0]))
                            <div class="widget adwidget">
                                {!! $ads[\App\Ad::TYPE_SIDEBAR][0]->code !!}
                            </div>
                        @endif

                        @if(isset($ads[\App\Ad::TYPE_SIDEBAR][1]))
                            <div class="widget adwidget">
                                {!! $ads[\App\Ad::TYPE_SIDEBAR][1]->code !!}
                            </div>
                        @endif
           ...
           <span class="read_only_raty"
                 data-score="{{$review->average_rating}}"></span>
                        ...
                        @for($i=2;$i<sizeof($ads[\App\Ad::TYPE_SIDEBAR]);$i++)
                            @if(isset($ads[\App\Ad::TYPE_SIDEBAR][$i]))
                                <div class="widget adwidget">
                                    {!! $ads[\App\Ad::TYPE_SIDEBAR][$i]->code !!}
                                </div>
                            @endif
                        @endfor
